...
const pageNames: Record<string, string> = {
  ...
  // VENDEDOR
  "/vendedor/dashboard": "Painel do vendedor",
  "/vendedor/produtos": "Produtos",
  "/vendedor/mercado": "Meu mercado",
  "/vendedor/precos": "Meus preços",
  "/vendedor/comparador": "Comparador",
  "/vendedor/configuracoes": "Configurações",
};
...
export function Header({ onMenuClick }: Props) {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b bg-white/90 px-4 backdrop-blur dark:bg-slate-950/90 sm:px-6">
      ...
      <Link
        to="/"
        className="hidden text-xl font-black tracking-tight text-brand-600 xl:block"
      >
        QuantoTá
      </Link>
      ...
      <nav
        ...
        className="hidden items-center gap-1 text-sm text-slate-500 xl:flex"
      >
